package ru.dbudyak.entangler.math;
...
public class KroneckerOperation {
    ...
    private static void sum(double[] A, int m, double[] B, int n,
                            double[] Im, double[] In,
                            double[] tmpA, double[] tmpB,
                            double[] C) {
    ...
    private static void product(double[] A, int m, int n, double[] B, int p, int q, double[] out) {
    ...
    private static void product(double[][] A, double[][] B, double[][] out) {
        final int m = A.length;
        final int n = A[0].length;
        final int p = B.length;
        final int q = B[0].length;
